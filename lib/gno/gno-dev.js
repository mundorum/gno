...
import { Oid, OidWeb } from "/lib/foundation/oidlib-dev.js";
Oid.cInterface({
  id: "itf:compiler",
  operations: ["compile"],
  flow: "pull"
...
class GnoLexer extends Ln.Lexer {
  constructor(input) {
    super(input);
    this._interp = new Ln.atn.LexerATNSimulator(this, atn$1, decisionsToDFA$1, new Ln.atn.PredictionContextCache());
  }
}
__publicField(GnoLexer, "grammarFileName", "GnoLexer.g4");
__publicField(GnoLexer, "channelNames", ["DEFAULT_TOKEN_CHANNEL", "HIDDEN"]);
__publicField(GnoLexer, "modeNames", ["DEFAULT_MODE"]);
__publicField(GnoLexer, "literalNames", [
  null,
  null,
  null,
  "' '",
...
__publicField(GnoLexer, "symbolicNames", [
  null,
  "TITLE",
  "ATX_START",
  "SPACE",
...
__publicField(GnoLexer, "ruleNames", [
  "TITLE",
  "ATX_START",
  "SPACE",
  "TAB",
...
GnoLexer.EOF = Ln.Token.EOF;
GnoLexer.TITLE = 1;
GnoLexer.ATX_START = 2;
GnoLexer.SPACE = 3;
GnoLexer.TAB = 4;
GnoLexer.NEWLINE = 5;
GnoLexer.OPEN_BRACKET = 6;
GnoLexer.CLOSE_BRACKET = 7;
GnoLexer.OPEN_PAREN = 8;
GnoLexer.CLOSE_PAREN = 9;
GnoLexer.EXCLAMATION = 10;
GnoLexer.IMAGE_URL = 11;
GnoLexer.IMAGE_TITLE = 12;
...
class GnoListener extends Ln.tree.ParseTreeListener {
  // Enter a parse tree produced by GnoParser#script.
  enterScript(ctx) {
  }
  // Exit a parse tree produced by GnoParser#script.
  exitScript(ctx) {
  }
  // Enter a parse tree produced by GnoParser#scene.
  enterScene(ctx) {
  }
  // Exit a parse tree produced by GnoParser#scene.
  exitScene(ctx) {
  }
  // Enter a parse tree produced by GnoParser#sceneHeader.
  enterSceneHeader(ctx) {
  }
  // Exit a parse tree produced by GnoParser#sceneHeader.
  exitSceneHeader(ctx) {
  }
...
const _GnoParser = class _GnoParser extends Ln.Parser {
  constructor(input) {
    super(input);
    this._interp = new Ln.atn.ParserATNSimulator(this, atn, decisionsToDFA, sharedContextCache);
    this.ruleNames = _GnoParser.ruleNames;
    this.literalNames = _GnoParser.literalNames;
    this.symbolicNames = _GnoParser.symbolicNames;
    this.translated = {
      scenes: []
    };
  ...
  script() {
    ...
    this.enterRule(localctx, 0, _GnoParser.RULE_script);
    var _la = 0;
    try {
  ...
  scene() {
    ...
    this.enterRule(localctx, 2, _GnoParser.RULE_scene);
    try {
      this.enterOuterAlt(localctx, 1);
  ...
  sceneHeader() {
    ...
    this.enterRule(localctx, 4, _GnoParser.RULE_sceneHeader);
    var _la = 0;
    try {
      this.enterOuterAlt(localctx, 1);
      this.state = 25;
      localctx._ATX_START = this.match(_GnoParser.ATX_START);
      this.state = 27;
      this._errHandler.sync(this);
      _la = this._input.LA(1);
      do {
      ...
      this.state = 31;
      localctx._TITLE = this.match(_GnoParser.TITLE);
      this.state = 35;
      this._errHandler.sync(this);
      _la = this._input.LA(1);
      while (_la === 3 || _la === 4) {
  ...
  sceneContent() {
    ...
    this.enterRule(localctx, 6, _GnoParser.RULE_sceneContent);
    try {
      this.enterOuterAlt(localctx, 1);
      this.state = 45;
      this._errHandler.sync(this);
  ...
  image() {
    ...
    this.enterRule(localctx, 8, _GnoParser.RULE_image);
    var _la = 0;
    try {
      this.enterOuterAlt(localctx, 1);
      this.state = 48;
      this.match(_GnoParser.EXCLAMATION);
      this.state = 49;
      this.match(_GnoParser.OPEN_BRACKET);
      this.state = 50;
      localctx._TITLE = this.match(_GnoParser.TITLE);
      this.state = 51;
      this.match(_GnoParser.CLOSE_BRACKET);
      this.state = 52;
      this.match(_GnoParser.OPEN_PAREN);
      this.state = 53;
      localctx._IMAGE_URL = this.match(_GnoParser.IMAGE_URL);
      this.state = 60;
      this._errHandler.sync(this);
      _la = this._input.LA(1);
      if (_la === 3) {
        ...
        do {
          this.state = 54;
          this.match(_GnoParser.SPACE);
          this.state = 57;
          this._errHandler.sync(this);
          _la = this._input.LA(1);
        } while (_la === 3);
        this.state = 59;
        localctx._IMAGE_TITLE = this.match(_GnoParser.IMAGE_TITLE);
      }
      this.state = 62;
      this.match(_GnoParser.CLOSE_PAREN);
...
__publicField(_GnoParser, "grammarFileName", "Gno.g4");
__publicField(_GnoParser, "literalNames", [
  null,
  null,
  null,
  "' '",
...
__publicField(_GnoParser, "symbolicNames", [
  null,
  "TITLE",
  "ATX_START",
  "SPACE",
...
__publicField(_GnoParser, "ruleNames", [
  "script",
  "scene",
  "sceneHeader",
  "sceneContent",
...
let GnoParser = _GnoParser;
GnoParser.EOF = Ln.Token.EOF;
GnoParser.TITLE = 1;
...
class ScriptContext extends Ln.ParserRuleContext {
  constructor(parser, parent, invokingState) {
    ...
    __publicField(this, "scene", function(i2) {
      if (i2 === void 0) {
        i2 = null;
      }
      if (i2 === null) {
        ...
        return this.getTypedRuleContext(SceneContext, i2);
      }
    });
    __publicField(this, "NEWLINE", function(i2) {
      if (i2 === void 0) {
        i2 = null;
      }
      if (i2 === null) {
        ...
        return this.getToken(GnoParser.NEWLINE, i2);
      }
    });
    this.parser = parser;
...
class SceneContext extends Ln.ParserRuleContext {
  constructor(parser, parent, invokingState) {
    if (parent === void 0) {
      parent = null;
    }
...
class SceneHeaderContext extends Ln.ParserRuleContext {
  constructor(parser, parent, invokingState) {
    if (parent === void 0) {
      parent = null;
    }
    ...
    super(parent, invokingState);
    __publicField(this, "SPACE", function(i2) {
      if (i2 === void 0) {
        i2 = null;
      }
      if (i2 === null) {
        ...
        return this.getToken(GnoParser.SPACE, i2);
      }
    });
    __publicField(this, "TAB", function(i2) {
      if (i2 === void 0) {
        i2 = null;
      }
      if (i2 === null) {
        ...
        return this.getToken(GnoParser.TAB, i2);
      }
    });
    this.parser = parser;
...
class SceneContentContext extends Ln.ParserRuleContext {
  constructor(parser, parent, invokingState) {
    if (parent === void 0) {
      parent = null;
    }
    ...
    super(parent, invokingState);
    __publicField(this, "image", function(i2) {
      if (i2 === void 0) {
        i2 = null;
      }
      if (i2 === null) {
        ...
        return this.getTypedRuleContext(ImageContext, i2);
      }
    });
    __publicField(this, "NEWLINE", function(i2) {
      if (i2 === void 0) {
...
class ImageContext extends Ln.ParserRuleContext {
  constructor(parser, parent, invokingState) {
    if (parent === void 0) {
      parent = null;
    }
...
class GnoCompilerOid extends OidWeb {
  handleCompile(topic, message) {
    ...
    if (message.value) {
      ...
      compiled.message = parser._syntaxErrors > 0 ? `Parser error: ${parser._syntaxErrors} error(s) found` : "Parsing successful";
...
//# sourceMappingURL=gno-dev.js.map
